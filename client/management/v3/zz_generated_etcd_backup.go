...
const (
	...
	EtcdBackupFieldS3EtcdBackup    = "s3EtcdBackup"
...
type EtcdBackup struct {
	...
	BackupConfig    string            `json:"backupConfig,omitempty" yaml:"backupConfig,omitempty"`
	...
	S3EtcdBackup    *S3EtcdBackup     `json:"s3EtcdBackup,omitempty" yaml:"s3EtcdBackup,omitempty"`
